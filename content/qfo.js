...
var domainTo = fieldtocontains.match(checkTo); 
var truedomainTo = domainTo ? domainTo.length : 0;


var domainCC = fieldcopycontains.match(checkTo); 
var truedomainCC = domainCC ? domainCC.length : 0;
...
var trueallCC = allCC ? allCC.length : 0;
 ...
 var internally = (truedomainTo + truedomainCC) > ((trueallTo + trueallCC) / 2) ? true : false;
